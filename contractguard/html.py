...
def generate_html_report(result: AnalysisResult, lang: str = "en") -> str:
    ...
    disclaimer = _esc(DISCLAIMER["zh" if lang == "zh" else "en"])
    scope_note = _esc(SCOPE_NOTE["zh" if lang == "zh" else "en"])
...
<div class="page">
  ...
  <div class="footer">
    <p>{disclaimer}</p>
    <p>{scope_note}</p>
    <p>Generated by ContractGuard — never sign a bad contract again.</p>
  </div>
</div>
</body>
</html>
